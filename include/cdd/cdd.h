...
typedef void (*cdd_print_varloc_f)(FILE* out, uint32_t* mask, uint32_t* value, void* data,
                                   int32_t size);
 ...
 */
extern void cdd_fprint_code(FILE* ofile, ddNode* cdd, cdd_print_varloc_f printer1,
                            cdd_print_clockdiff_f printer2, void* data);
extern void cdd_fprint_graph(FILE* ofile, ddNode* cdd, cdd_print_varloc_f printer1,
                             cdd_print_clockdiff_f printer2, void* data);
 ...
 * @see cdd_intervalpp
 */
inline cdd cdd_lowerpp(int32_t i, int32_t j, raw_t bound)
{
 ...
 * @see cdd_upper
 */
inline cdd cdd_intervalpp(int32_t i, int32_t j, raw_t low, raw_t up)
{
    return cdd(cdd_interval(i, j, low, up));
}
 ...
 * @todo
 */
inline cdd cdd_exist(const cdd& r, int32_t* levels, int32_t* clocks)
{
 ...
 * @todo
 */
inline cdd cdd_replace(const cdd& r, int32_t* f, int32_t* g)
{
    return cdd(cdd_replace(r.root, f, g));
}
 ...
 * BDD and lower part a CDD
 */
inline void cdd_fprint_code(FILE* ofile, const cdd& cdd, cdd_print_varloc_f printer1,
                            cdd_print_clockdiff_f printer2, void* data)
{
    cdd_fprint_code(ofile, cdd.root, printer1, printer2, data);
}
inline void cdd_fprint_graph(FILE* ofile, const cdd& cdd, cdd_print_varloc_f printer1,
                             cdd_print_clockdiff_f printer2, void* data)
{
...
#ifdef MULTI_TERMINAL
inline cdd cdd_apply_tautology(const cdd& dd, int32_t t_id)
{
    return cdd(cdd_apply_tautology(dd.root, t_id));
}
