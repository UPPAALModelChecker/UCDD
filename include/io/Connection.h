...
namespace io
{
    ...
    public:
         ...
         */
        const char* read(size_t* len = nullptr);
         ...
         */
        bool read(char* buffer, size_t count, size_t* len = nullptr);
    ...
    {
        size_t size;
        return read((char*)obj, sizeof(obj), &size) && size == sizeof(obj);
    }
    ...
    inline bool Connection::isOpen() const { return socketfd >= 0; }

    inline bool Connection::write(const std::string& str)
    {
